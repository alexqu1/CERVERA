...
if (!isset($_POST['submit'])) {
    $id=$_GET['id'];
$consulta= "select * from Empleo WHERE id='$id'";
...
echo "<form method='POST' action='Modificar_Empleo.php' >";
echo "<tr>";
...
$D=$_POST["Archivos"];
$consulta="UPDATE Empleo SET id='$I' , Nombre='$N',  Archivos='$D' WHERE id='$I' ";
$datos=mysqli_query($con,$consulta) ; 
